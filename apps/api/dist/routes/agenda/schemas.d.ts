import { z } from "zod";
export declare const StatusAgendaSchema: z.ZodEnum<["PLANEJADO", "CONFIRMADO", "REALIZADO", "CANCELADO"]>;
export declare const PrioridadeAgendaSchema: z.ZodEnum<["BAIXA", "MEDIA", "ALTA", "URGENTE"]>;
...
export declare const UpdateAgendaItemSchema: z.ZodObject<{
    ...
    status: z.ZodOptional<z.ZodEnum<["PLANEJADO", "CONFIRMADO", "REALIZADO", "CANCELADO"]>>;
    observacoes: z.ZodOptional<z.ZodNullable<z.ZodString>>;
}, "strip", z.ZodTypeAny, {
