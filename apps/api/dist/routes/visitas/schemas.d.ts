import { z } from "zod";
export declare const StatusVisitaSchema: z.ZodEnum<["AGENDADA", "REALIZADA", "CANCELADA", "NAO_REALIZADA"]>;
...
export declare const CreateVisitaInputSchema: z.ZodObject<{
    ...
    status: z.ZodDefault<z.ZodEnum<["AGENDADA", "REALIZADA", "CANCELADA", "NAO_REALIZADA"]>>;
    ...
    materiais: z.ZodDefault<z.ZodArray<z.ZodObject<{
        materialTecnicoId: z.ZodString;
        quantidade: z.ZodDefault<z.ZodNumber>;
    }, "strip", z.ZodTypeAny, {
        materialTecnicoId: string;
    ...
    dataVisita: string | Date;
    profissionalId: string;
    status?: "AGENDADA" | "REALIZADA" | "CANCELADA" | "NAO_REALIZADA" | undefined;
    materiais?: {
        materialTecnicoId: string;
        quantidade?: number | undefined;
    }[] | undefined;
...
export declare const UpdateVisitaInputSchema: z.ZodObject<{
    status: z.ZodOptional<z.ZodDefault<z.ZodEnum<["AGENDADA", "REALIZADA", "CANCELADA", "NAO_REALIZADA"]>>>;
    materiais: z.ZodOptional<z.ZodDefault<z.ZodArray<z.ZodObject<{
        materialTecnicoId: z.ZodString;
        quantidade: z.ZodDefault<z.ZodNumber>;
    }, "strip", z.ZodTypeAny, {
        materialTecnicoId: string;
    ...
    motivoCancelamento: z.ZodOptional<z.ZodOptional<z.ZodNullable<z.ZodString>>>;
    motivoNaoRealizacao: z.ZodOptional<z.ZodOptional<z.ZodNullable<z.ZodString>>>;
}, "strip", z.ZodTypeAny, {
    status?: "AGENDADA" | "REALIZADA" | "CANCELADA" | "NAO_REALIZADA" | undefined;
    materiais?: {
        materialTecnicoId: string;
...
export declare const ListVisitasQuerySchema: z.ZodObject<{
    ...
    status: z.ZodOptional<z.ZodEnum<["AGENDADA", "REALIZADA", "CANCELADA", "NAO_REALIZADA"]>>;
