...
import { prisma } from '@medivisitas/database';
import { CreateProfissionalInputSchema, UpdateProfissionalInputSchema, ListProfissionaisQuerySchema, UpdateEstagioInputSchema, ProfissionalOutputSchema, ProfissionaisListOutputSchema, } from './schemas';
export default async function profissionaisRoutes(app) {
    ...
    app.post('/profissionais', {
        ...
        schema: {
            body: CreateProfissionalInputSchema,
            response: {
                201: ProfissionalOutputSchema,
    ...
    app.get('/profissionais', {
        preHandler: [verifyClerkToken],
        schema: {
            querystring: ListProfissionaisQuerySchema,
            response: {
                200: ProfissionaisListOutputSchema,
                401: { type: 'object', properties: { error: { type: 'string' } } },
            },
        },
    }, async (request, reply) => {
    ...
    app.put('/profissionais/:id', {
        preHandler: [verifyClerkToken],
        schema: {
            body: UpdateProfissionalInputSchema,
            response: {
                200: ProfissionalOutputSchema,
                404: { type: 'object', properties: { error: { type: 'string' } } },
                401: { type: 'object', properties: { error: { type: 'string' } } },
    ...
    // ============================================
    app.patch('/profissionais/:id/estagio', {
        preHandler: [verifyClerkToken],
        schema: {
            body: UpdateEstagioInputSchema,
            response: {
                200: ProfissionalOutputSchema,
                404: { type: 'object', properties: { error: { type: 'string' } } },
                400: { type: 'object', properties: { error: { type: 'string' } } },
