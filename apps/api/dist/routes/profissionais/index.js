...
import { z } from "zod";
import { CreateProfissionalInputSchema, UpdateProfissionalInputSchema, ListProfissionaisQuerySchema, UpdateEstagioInputSchema, ProfissionalOutputSchema, } from "./schemas";
export default async function profissionaisRoutes(app) {
    ...
    // ============================================
    app.patch("/profissionais/:id/ativo", {
        preHandler: [verifyClerkToken],
    }, async (request, reply) => {
        const { id } = request.params;
