    ...
    <div class="space-y-2.5 max-h-[400px] overflow-y-auto pr-2">
      {#each alertas as alerta}
        ...
        <a
          ...
          class="flex items-start gap-3 p-3 rounded-lg border-l-3 {config.borderClass} bg-[rgb(var(--slate-50))]/50 hover:bg-[rgb(var(--slate-50))] will-change-transform transition-all duration-200 hover:-translate-y-[1px] hover:shadow-sm"
        >
