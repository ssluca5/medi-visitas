...
function _page($$renderer) {
  const redirectUrl = typeof window !== "undefined" ? `${PUBLIC_CLERK_SIGN_IN_HOSTED_URL}?redirect_url=${encodeURIComponent(window.location.origin + "/dashboard")}` : PUBLIC_CLERK_SIGN_IN_HOSTED_URL;
