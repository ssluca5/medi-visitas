...
type LayoutRouteId = RouteId | "/" | "/aceitar-convite/[token]" | "/dashboard" | "/dashboard/agenda" | "/dashboard/equipe" | "/dashboard/especialidades" | "/dashboard/gestor" | "/dashboard/materiais" | "/dashboard/notificacoes" | "/dashboard/perfil" | "/dashboard/pipeline" | "/dashboard/profissionais" | "/dashboard/profissionais/[id]" | "/dashboard/relatorios" | "/dashboard/visitas" | "/dashboard/[...404]" | "/login" | "/onboarding" | "/planos" | null
type LayoutParams = RouteParams & { token?: string; id?: string; 404?: string }
