...
<!-- Fonte única de verdade para todos os agentes AI (Codex/Antigravity, Claude Code, etc.) -->
...
| 5    | IA — transcrição MiniMax           | ✅ Concluída |
...
### Fase 5 — IA: Transcrição com MiniMax
...
- **Testes:** testado (MiniMax service + route auth)
